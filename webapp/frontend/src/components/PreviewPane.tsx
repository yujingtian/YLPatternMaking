...
import type { PiecesResult, SheetResult, Snapshot } from '../types'
...
export default function PreviewPane({ sheet, pieces, sheetStale, piecesStale }: {
  ...
  const items = [
    ...(sheet
      ? [{ key: 'sheet', label: '整版',
          children: <SvgView svg={sheet.data.sheet_svg} /> }]
      : []),
    ...(pieces
